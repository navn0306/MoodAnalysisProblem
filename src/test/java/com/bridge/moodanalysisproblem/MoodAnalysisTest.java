...
public class MoodAnalysisTest {
    ...
    @Test
    public void givenMessageWhenEmptyItShouldReturnHappy() throws MoodAnalysisException {
        MoodAnalysisProblem mood = new MoodAnalysisProblem("");
        String actualMood;
        try {
            actualMood = mood.moodAnalysis();
        } catch (MoodAnalysisException e) {
